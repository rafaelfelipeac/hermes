...
object TrophyDefinitions {
    val supportedV1: List<TrophyDefinition> =
        listOf(
            definition(
                id = TrophyId.CHALLENGE_ACCEPTED,
            ...
            definition(
                id = TrophyId.CHALLENGE_MOMENTUM,
                family = TrophyFamily.CHALLENGES,
                metric = TrophyMetric.CHALLENGE_COMPLETIONS,
                target = 5,
                sortOrder = 30,
            ...
            definition(
                id = TrophyId.EVENT_PLANNER,
                family = TrophyFamily.RACE_EVENTS,
                metric = TrophyMetric.RACE_EVENT_CREATIONS,
                target = 10,
                sortOrder = 10,
                badgeRank = 1,
            ),
            definition(
                id = TrophyId.EVENT_CALENDAR,
                family = TrophyFamily.RACE_EVENTS,
                metric = TrophyMetric.RACE_EVENT_CREATIONS,
                target = 25,
                sortOrder = 20,
            ...
            definition(
                id = TrophyId.RACE_READY,
                family = TrophyFamily.RACE_EVENTS,
                metric = TrophyMetric.RACE_EVENT_COMPLETIONS,
                target = 5,
                sortOrder = 40,
                badgeRank = 1,
            ),
            definition(
                id = TrophyId.RACE_SHARP,
                family = TrophyFamily.RACE_EVENTS,
                metric = TrophyMetric.RACE_EVENT_COMPLETIONS,
                target = 15,
                sortOrder = 50,
            ...
            definition(
                id = TrophyId.FIRST_BENCHMARK,
                family = TrophyFamily.PERSONAL_RECORDS,
                metric = TrophyMetric.PERSONAL_RECORD_FAMILY_CREATIONS,
                target = 1,
                sortOrder = 10,
                badgeRank = 1,
            ),
            definition(
                id = TrophyId.BENCHMARK_BUILDER,
                family = TrophyFamily.PERSONAL_RECORDS,
                metric = TrophyMetric.PERSONAL_RECORD_FAMILY_CREATIONS,
                target = 5,
                sortOrder = 20,
            ...
            definition(
                id = TrophyId.ON_THE_BOARD,
                family = TrophyFamily.PERSONAL_RECORDS,
                metric = TrophyMetric.PERSONAL_RECORD_ENTRY_CREATIONS,
                target = 1,
                sortOrder = 40,
                badgeRank = 1,
            ),
            definition(
                id = TrophyId.FORM_BOOK,
                family = TrophyFamily.PERSONAL_RECORDS,
                metric = TrophyMetric.PERSONAL_RECORD_ENTRY_CREATIONS,
                target = 10,
                sortOrder = 50,
